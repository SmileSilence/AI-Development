---
name: code-style
description: "用于代码规范、编码标准与代码风格指南：代码格式化、命名约定、注释规范、region 划分与代码审查。当用户请求格式化代码、统一代码风格、命名/注释规范或代码审查时激活。"
metadata:
  version: "v5"
...
### 不触发（避免误用）
- 完整的编码/生成/重构流程（非规范问题）→ 不激活本技能
- UE / Unity 引擎特有规范 → 不激活本技能（引擎项目遵循引擎自身规范）
