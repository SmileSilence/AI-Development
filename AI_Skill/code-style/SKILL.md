...
### 不触发（避免误用）
- 完整的编码/生成/重构流程（非规范问题）→ 用 `ai-coding-workflow`
- UE / Unity 引擎特有规范 → 用 `ue-development` / `unity-development`

### 与其他技能的边界
- `ai-coding-workflow` 管「编码流程」，`code-style` 管「代码规范」；同一编码任务可两者并用
...
- v5 (2026-08-27): 优化触发条件：细化自动触发关键词，补充不触发场景及与 ai-coding-workflow / 引擎技能的边界
