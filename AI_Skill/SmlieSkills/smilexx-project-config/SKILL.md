...
| 2026-09-03 | v7.1 | 补充 metadata.platforms 与 metadata.keywords 字段，符合 smilexx-skill-creator v7 元数据规范 |
| 2026-08-29 | v7 | 精简技能目录描述，保留工作区与项目配置触发条件 |
| 2026-08-28 | v6 | 技能名改为 kebab-case（smilexx-project-config），符合 DSH 加载规范 |
