---
name: smilexx-unity-plugin-development
...
- 用户说「smilexx-unity-plugin-development」
...
| 日期 | 版本 | 变更说明 |
|------|------|----------|
| 2026-09-11 | v3.2 | 技能更名为 smilexx-unity-plugin-development，统一自有技能标识 |
| 2026-09-03 | v3.1 | 补充 metadata.platforms 与 metadata.keywords 字段，符合 smilexx-skill-creator v7 元数据规范 |
