...
> 整理日期：2026-09-10（复核 2026-09-03 版，版本号已与实际 SKILL.md 对齐）
...
| smile-global-config | SmileXX | v19 | 全局配置 | 全局简体中文配置 + AI Agent 管理（启动、文件卫生、会话同步；由 smile-global-config + anget-manager 合并） | 安装后自动激活 | ✅ 已安装 |
| smile-project-config | SmileXX | v7.3 | 项目规范 | 项目结构、Git、文档模板与配置 | D:\Work\Project 项目配置任务 | ✅ 已安装 |
