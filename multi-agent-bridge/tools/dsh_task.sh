...
#   工作区ID 默认: e0f71147... (multi-agent-bridge)
set -euo pipefail

BRIDGE="D:/Work/AI-Development/multi-agent-bridge"
...
if { echo "$TASK"; echo "$WS_ID"; } | grep -qiE "AI_Plugins|plugin|插件|\.dsh|profiles/web|deepseek-harness|package\.json|5cb342c8"; then
  SUP_FLAG="/d/Work/AI-Development/multi-agent-bridge/logs/supervisor-active.flag"
